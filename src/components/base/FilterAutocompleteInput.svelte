        ...
        return StreamLanguage.define(
            simpleMode({
                start: [
                    ...
                    // { regex: CommonHelper.escapeRegExp("@heute"), token: "keyword" },
                    // { regex: CommonHelper.escapeRegExp("@gestern"), token: "keyword" },
                    // { regex: CommonHelper.escapeRegExp("@diesewoche"), token: "keyword" },
                    // { regex: CommonHelper.escapeRegExp("@diesesjahr"), token: "keyword" },
                    // { regex: CommonHelper.escapeRegExp("@diesenmonat"), token: "keyword" },
