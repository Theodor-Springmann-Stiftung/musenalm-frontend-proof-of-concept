    ...
    },
    {
        ...
        columns: [
            ...
            },
            {
                ...
                sortProxy:
                    "Bevorzugter_Reihentitel.Titel,Alternativer_Reihentitel.Titel,Franzoesischer_Reihentitel.Titel,Deutscher_Reihentitel.Titel,Alternatives_Titelblatt.Titel,TA_von.Titel,hat_TA.Titel",
                fields: [
                    {
                ...
                menu: [
                    {
                        ...
                        ref: "id",
                        fields: [
                            "Bevorzugter_Reihentitel.id",
                            "Alternativer_Reihentitel.id",
                            "Franzoesischer_Reihentitel.id",
                            "Deutscher_Reihentitel.id",
                            "Alternatives_Titelblatt.id",
                            "TA_von.id",
                            "hat_TA.id",
                        ],
                        sort: "Jahr,Kurztitel",
